...
class Logger:
    ...
    def save_initial_state(self, fire_obj: FireSim) -> None:
        ...
        dict = {
            ...
            'temp_forecast': [entry.temp for entry in fire_obj._weather_stream.stream[fire_obj.sim_start_w_idx:]],
            'rh_forecast': [entry.rel_humidity for entry in fire_obj._weather_stream.stream[fire_obj.sim_start_w_idx:]],
